...
def get_args_parser():
    ...
    parser.add_argument('--thresh_attn', default=0.5, type=float)
    parser.add_argument('--thresh_mlp', default=0.5, type=float)
    parser.add_argument('--thresh_patch', default=0.5, type=float)
...
def main(args):
    ...
    if args.distributed:
        ...
        thresh_attn, thresh_mlp, thresh_patch = model.module.compress_with_thresh(args.thresh_attn, args.thresh_mlp, args.thresh_patch)
